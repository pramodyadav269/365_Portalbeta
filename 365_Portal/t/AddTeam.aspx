<%@ Page Title="" Language="C#" MasterPageFile="~/t/admin.Master" AutoEventWireup="true" CodeBehind="AddTeam.aspx.cs" Inherits="_365_Portal.t.AddTeam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12 header mb-5">
            ...
            <h2 class="text-center font-weight-bold">Add Team</h2>
        </div>
        ...
        function Submit() {
            ...
            if (inputValidation('.input-validation')) {
                ...
                if ($('#submit')[0].name == INSERT) {
                    getUrl = "/API/User/CreateTeam";
                } else {
                    _ID = id;
                    getUrl = "/API/User/ModifyTeam";
                }
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    try {
                        ...
                        var getUrl = "/API/User/DeleteTeam";
                                ...
                                if (DataSet.StatusCode == "1") {
                                    if (DataSet.Data.length > 0) {
                                        $.each(DataSet.Data, function (i, data) {
                                            tbl += '<tr id="' + data.Id + '">';
                                            tbl += '<td>' + (i + 1);
                                            tbl += '<td class="title">' + data.TeamName;

 ...
 */
!function(t, i) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = i(require("hammerjs")) : "function" == typeof define && define.amd ? define(["hammerjs"], i) : t.Muuri = i(t.Hammer)
}(this, function(t) {
    "use strict";
    ...
    n.prototype.emit = function(t, i, e, s) {
        ...
        if (!n || !n.length)
            return this;
        var r, o, h = this._queue, a = h.length, _ = arguments.length - 1;
        for (o = 0; o < n.length; o++)
            h.push(n[o]);
        for (r = h.length,
        ++this._processCount,
        o = a; o < r; o++)
            if (0 === _ ? h[o]() : 1 === _ ? h[o](i) : 2 === _ ? h[o](i, e) : h[o](i, e, s),
            this._isDestroyed)
                return this;
        return --this._processCount,
        this._processCount || r !== h.length || (h.length = 0),
        this
    }
    ,
    ...
    function l(t, i) {
        var e = {};
        for (var s in i)
            e[s] = _(t, s.replace(/([A-Z])/g, "-$1").toLowerCase());
        return e
    }
    function d(t, i) {
        for (var e in i)
    ...
    f.prototype.start = function(t, i, e) {
        if (!this._isDestroyed) {
            var s, n = e || 0, r = "function" == typeof n.onFinish ? n.onFinish : null, o = !1;
            if (this._animation) {
                for (s in i)
                    if (i[s] !== this._propsTo[s]) {
                        o = !0;
                        break
                    }
                if (!o)
                    return void (this._callback = r);
                this._animation.cancel()
            }
            for (s in this._callback = r,
            this._propsTo = {},
            i)
                this._propsTo[s] = i[s];
            this._keyframes[0] = t,
            this._keyframes[1] = i,
            this._options.duration = n.duration || 300,
            this._options.easing = n.easing || "ease",
    ...
    f.prototype.stop = function(t) {
        !this._isDestroyed && this._animation && (d(this._element, t || l(this._element, this._propsTo)),
        this._animation.cancel(),
    ...
    ;
    var u = (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
    ...
    c.prototype._flush = function() {
        ...
        for (i = 0; i < a; i++)
            ...
            h[t] = void 0);
        r.length = 0,
        !this._nextTick && e.length && (this._nextTick = u(this._flush))
    }
    ;
    var p = new c
      , m = Element.prototype
      , g = m.matches || m.matchesSelector || m.webkitMatchesSelector || m.mozMatchesSelector || m.msMatchesSelector || m.oMatchesSelector;
    function y(t, i) {
        return g.call(t, i)
    }
    var v = "classList"in Element.prototype ? function(t, i) {
        t.classList.add(i)
    }
    : function(t, i) {
        y(t, "." + i) || (t.className += " " + i)
    ...
    function C(t, i) {
        ...
        return i > 0 ? function(s) {
            ...
            s === A && t()),
            s !== S && s !== A && (e = window.setTimeout(function() {
                e = void 0,
                t()
            }, i))
        }
    ...
    function R(t, i) {
        for (var e = (i ? t : t.parentElement) || document; e && e !== document && "static" === _(e, "position") && !x(e); )
    ...
    function H(t, i) {
        ...
        s.left += e.left,
        s.top += e.top,
        s.left += I(t, "border-left-width"),
        s.top += I(t, "border-top-width"),
        s))
    }
    function G(t, i, e) {
        return M.left = 0,
        M.top = 0,
        t === i ? M : e && (t = R(t, !0)) === (i = R(i, !0)) ? M : (H(t, L),
        H(i, E),
        M.left = E.left - L.left,
        M.top = E.top - L.top,
        M)
    }
    var T = {};
    function P(t) {
        ...
        return T.x = parseFloat(e[4]) || 0,
        T.y = parseFloat(e[5]) || 0,
        T
    }
    function k(t, i) {
    ...
    function X(t, i, e) {
        ...
        s < 0 && (s = t.length - s + 1),
        t.splice.apply(t, O.concat(s, 0, i)),
        O.length = 0
    }
    var Y = "[object Object]"
      , q = Object.prototype.toString;
    function B(t) {
        return "object" == typeof t && q.call(t) === Y
    }
    var N = "classList"in Element.prototype ? function(t, i) {
        t.classList.remove(i)
    }
    : function(t, i) {
        y(t, "." + i) && (t.className = (" " + t.className + " ").replace(" " + i + " ", " ").trim())
    }
      , F = Q()
      , z = 0
      , V = 1
    ...
    function U(e) {
        ...
        null === F && (F = Q());
        var s, n, r = this, o = e._element, h = e.getGrid(), a = h._settings, _ = "function" == typeof a.dragStartPredicate ? a.dragStartPredicate : U.defaultStartPredicate, l = z;
        this._item = e,
        this._gridId = h._id,
        ...
        this._forceResolveStartPredicate = function(t) {
            this._isDestroyed || l !== V || (l = W,
            this._onStart(t))
        }
        ,
        this._checkOverlapDebounce = C(this._checkOverlap, a.dragSortInterval),
        s.add(new t.Pan({
            event: "drag",
            pointers: 1,
            threshold: 0,
        ...
        B(a.dragHammerSettings) && s.set(a.dragHammerSettings),
        s.on("draginit dragstart dragmove", function(t) {
            l === z && (l = V),
            l === V ? !0 === (n = _(r._item, t)) ? (l = W,
            r._onStart(t)) : !1 === n && (l = j) : l === W && r._isActive && r._onMove(t)
        ...
        o.addEventListener("dragstart", Z, !1)
    }
    function Z(t) {
    ...
    function J(t, i) {
        ...
        for (; s && s !== document; )
            "fixed" !== _(t, "position") || x(s) ? (K(s) && e.push(s),
            t = s,
    ...
    U.defaultStartPredicate = function(t, i, e) {
        var s = t._drag
    ...
    ,
    U.defaultSortPredicate = function() {
        var t = {}
          , i = {}
          , e = {}
          , s = [];
    ...
    U.prototype.stop = function() {
        var t = this._item._element
          , i = this._getGrid();
        return this._isActive ? this._isMigrating ? (this._finishMigration(),
        this) : (this._cancelAsyncUpdates(),
        this._unbindScrollListeners(),
        this._checkOverlapDebounce("cancel"),
        t.parentNode !== i._element && (i._element.appendChild(t),
        t.style[h] = k(this._gridX, this._gridY)),
        N(t, i._settings.itemDraggingClass),
        this._reset(),
        this) : this
    }
    ,
    U.prototype.destroy = function() {
        ...
        this._item._element.removeEventListener("dragstart", Z, !1),
        this._isDestroyed = !0,
        this)
    }
    ,
    ...
    ,
    U.prototype._setupStartPredicate = function(t) {
    ...
    ,
    U.prototype._getStartPredicateHandle = function(t) {
        var i = this._startPredicateData
          , e = this._item._element
          , s = e;
        if (!i.handle)
            return s;
        for (s = (t.changedPointers[0] || 0).target; s && !y(s, i.handle); )
            s = s !== e ? s.parentElement : null;
        return s || null
    }
    ,
    U.prototype._resolveStartPredicate = function(t) {
    ...
    ,
    U.prototype._finishStartPredicate = function(t) {
    ...
    U.prototype._checkOverlap = function() {
        if (this._isActive) {
            ...
            (t = "function" == typeof a.dragSortPredicate ? a.dragSortPredicate(h, this._lastEvent) : U.defaultSortPredicate(h, a.dragSortPredicate)) && "number" == typeof t.index && (o = (i = h.getGrid()) !== (s = t.grid || i),
            e = i._items.indexOf(h),
            n = w(s._items, t.index, o),
            ...
            i.layout(),
            s.layout()) : e !== n && (("swap" === r ? b : D)(i._items, e, n),
    ...
    U.prototype._finishMigration = function() {
        var t, i, e = this._item, s = e._release, n = e._element, r = e._isActive, o = e.getGrid(), a = o._element, _ = o._settings, l = _.dragContainer || a, f = this._getGrid()._settings, u = n.parentNode;
        this._isMigrating = !1,
        this.destroy(),
        N(n, f.itemClass),
        N(n, f.itemVisibleClass),
        N(n, f.itemHiddenClass),
        v(n, _.itemClass),
        v(n, r ? _.itemVisibleClass : _.itemHiddenClass),
        l !== u && (l.appendChild(n),
        i = G(u, l, !0),
        (t = P(n)).x -= i.left,
        t.y -= i.top),
        ...
        e._drag = _.dragEnabled ? new U(e) : null,
        l !== u && (n.style[h] = k(t.x, t.y)),
        e._child.removeAttribute("style"),
        d(e._child, r ? _.visibleStyles : _.hiddenStyles),
        s.start()
    }
    ,
    U.prototype._cancelAsyncUpdates = function() {
        var t = this._item._id;
        p.cancel(t + "move"),
        p.cancel(t + "scroll")
    }
    ,
    U.prototype._onStart = function(t) {
        var i = this._item;
        if (i._isActive) {
            var e, s = i._element, n = this._getGrid(), r = n._settings, o = i._release, a = i._migrate, _ = n._element, l = r.dragContainer || _, d = R(l, !0), f = P(s), u = f.x, c = f.y, p = s.getBoundingClientRect(), m = l !== _;
            m && (e = G(d, _)),
            ...
            l.appendChild(s),
            s.style[h] = k(this._left, this._top))),
            v(s, r.itemDraggingClass),
            this._bindScrollListeners(),
            n._emit("dragStart", i, t)
        }
    }
    ,
    U.prototype._onMove = function(t) {
        var i = this._item;
        if (i._isActive) {
            var e = this._getGrid()._settings.dragAxis
              , s = t.deltaX - this._lastEvent.deltaX
              , n = t.deltaY - this._lastEvent.deltaY;
            this._lastEvent = t,
            "y" !== e && (this._left += s,
            this._gridX += s,
            this._elementClientX += s),
            "x" !== e && (this._top += n,
            this._gridY += n,
            this._elementClientY += n),
            p.add(i._id + "move", this._prepareMove, this._applyMove, !0)
        } else
            this.stop()
    }
    ,
    ...
    U.prototype._applyMove = function() {
        var t = this._item;
        t._isActive && (t._element.style[h] = k(this._left, this._top),
        this._getGrid()._emit("dragMove", t, this._lastEvent))
    }
    ,
    U.prototype._onScroll = function(t) {
        var i = this._item;
        i._isActive ? (this._lastScrollEvent = t,
        p.add(i._id + "scroll", this._prepareScroll, this._applyScroll, !0)) : this.stop()
    }
    ,
    U.prototype._prepareScroll = function() {
        ...
        if (t._isActive) {
            ...
            this._container !== o && (i = G(this._containingBlock, o),
    ...
    ,
    tt.prototype.flush = function(t, i) {
        if (this._isDestroyed)
            return this;
    ...
    ,
    it.prototype.start = function(t, i) {
        if (!this._isDestroyed) {
            var e, s, n, r = this._item, o = r._element, h = r._migrate, a = r._release, _ = r.getGrid()._settings, l = this._isActive, f = a._isActive && !1 === a._isPositioningStarted, u = f ? _.dragReleaseDuration : _.layoutDuration, c = f ? _.dragReleaseEasing : _.layoutEasing, m = !t && !this._skipNextAnimation && u > 0;
            return l && this._queue.flush(!0, r),
            f && (a._isPositioningStarted = !0),
            "function" == typeof i && this._queue.add(i),
            e = a._isActive ? a._containerDiffX : h._isActive ? h._containerDiffX : 0,
            s = a._isActive ? a._containerDiffY : h._isActive ? h._containerDiffY : 0,
            this._targetStyles.transform = k(r._left + e, r._top + s),
            m ? (this._isActive = !0,
            ...
            this._offsetLeft = e,
            this._offsetTop = s,
            p.add(r._id, this._setupAnimation, this._startAnimation),
            this) : (l && p.cancel(r._id),
            n = r._animate.isAnimating(),
            this.stop(!1, this._targetStyles),
            !n && d(o, this._targetStyles),
            this._skipNextAnimation = !1,
            this._finish())
        }
    }
    ,
    it.prototype.stop = function(t, i) {
        if (this._isDestroyed || !this._isActive)
            return this;
        var e = this._item;
        return p.cancel(e._id),
        e._animate.stop(i),
        N(e._element, e.getGrid()._settings.itemPositioningClass),
        this._isActive = !1,
    ...
    ,
    it.prototype._finish = function() {
        if (!this._isDestroyed) {
            var t = this._item
              , i = t._migrate
              , e = t._release;
            this._isActive && (this._isActive = !1,
            N(t._element, t.getGrid()._settings.itemPositioningClass)),
            e._isActive && e.stop(),
            i._isActive && i.stop(),
    ...
    ,
    it.prototype._setupAnimation = function() {
        var t = P(this._item._element);
        this._currentLeft = t.x - this._offsetLeft,
        this._currentTop = t.y - this._offsetTop
    }
    ,
    it.prototype._startAnimation = function() {
        var t = this._item
          , i = t._element
          , e = t.getGrid()._settings;
        if (t._left === this._currentLeft && t._top === this._currentTop)
            return this._isInterrupted && this.stop(!1, this._targetStyles),
            this._isActive = !1,
            void this._finish();
        !this._isInterrupted && v(i, e.itemPositioningClass),
        this._currentStyles.transform = k(this._currentLeft + this._offsetLeft, this._currentTop + this._offsetTop),
    ...
    st.prototype.start = function(t, i, e) {
        if (this._isDestroyed)
            return this;
        var s, n, r, o, a, _, l, f, u = this._item, c = u._element, p = u.isVisible(), m = u.getGrid(), g = m._settings, y = t._settings, D = t._element, b = t._items, S = m._items.indexOf(u), A = e || document.body;
        if ("number" == typeof i)
            s = w(b, i, !0);
        else {
            if (!(n = t._getItem(i)))
        ...
        return (u.isPositioning() || this._isActive || u.isReleasing()) && (l = (_ = P(c)).x,
        f = _.y),
        u.isPositioning() && u._layout.stop(!0, {
            transform: k(l, f)
        }),
        this._isActive && (l -= this._containerDiffX,
        f -= this._containerDiffY,
        this.stop(!0, {
            transform: k(l, f)
        })),
        u.isReleasing() && (l -= u._release._containerDiffX,
        f -= u._release._containerDiffY,
        u._release.stop(!0, {
            transform: k(l, f)
        })),
        ...
        N(c, g.itemClass),
        N(c, g.itemVisibleClass),
        N(c, g.itemHiddenClass),
        v(c, y.itemClass),
        v(c, p ? y.itemVisibleClass : y.itemHiddenClass),
        m._items.splice(S, 1),
        X(b, u, s),
        u._gridId = t._id,
        A !== (r = c.parentNode) && (A.appendChild(c),
        o = G(A, r, !0),
        _ || (l = (_ = P(c)).x,
        f = _.y),
        c.style[h] = k(l + o.left, f + o.top)),
        u._child.removeAttribute("style"),
        d(u._child, p ? y.visibleStyles : y.hiddenStyles),
        c.style.display = p ? "block" : "hidden",
        a = G(A, D, !0),
        u._refreshDimensions(),
        u._refreshSortData(),
        u._drag = y.dragEnabled ? new U(u) : null,
        this._isActive = !0,
        this._container = A,
    ...
    ,
    st.prototype.stop = function(t, i) {
        if (this._isDestroyed || !this._isActive)
            return this;
        var e, s = this._item, n = s._element, r = s.getGrid()._element;
        return this._container !== r && (i || (t ? (e = P(n),
        et.transform = k(e.x - this._containerDiffX, e.y - this._containerDiffY)) : et.transform = k(s._left, s._top),
        i = et),
        r.appendChild(n),
        d(n, i)),
        this._isActive = !1,
    ...
    function ot(t) {
        ...
        v(e, i ? s.itemVisibleClass : s.itemHiddenClass),
        d(t._child, i ? s.visibleStyles : s.hiddenStyles)
    }
    rt.prototype.start = function() {
        ...
        v(t._element, i._settings.itemReleasingClass),
        i._emit("dragReleaseStart", t),
        t._layout.start(!1),
        this
    }
    ,
    rt.prototype.stop = function(t, i) {
        if (this._isDestroyed || !this._isActive)
            return this;
        var e, s = this._item, n = s._element, r = s.getGrid(), o = r._element;
        return this._reset(),
        n.parentNode !== o && (i || (t ? (e = P(n),
        nt.transform = k(e.x - this._containerDiffX, e.y - this._containerDiffY)) : nt.transform = k(s._left, s._top),
        i = nt),
        o.appendChild(n),
        d(n, i)),
    ...
    rt.prototype._reset = function() {
        if (!this._isDestroyed) {
            ...
            this._containerDiffX = 0,
            this._containerDiffY = 0,
            N(t._element, t.getGrid()._settings.itemReleasingClass)
        }
    }
    ,
    ot.prototype.show = function(t, i) {
        if (this._isDestroyed)
            return this;
        var e = this._item
          , s = e._element
        ...
        N(s, o.itemHiddenClass),
        v(s, o.itemVisibleClass),
    ...
    ,
    ot.prototype.hide = function(t, i) {
        if (this._isDestroyed)
            return this;
        var e = this._item
          , s = e._element
        ...
        v(s, o.itemHiddenClass),
        N(s, o.itemVisibleClass)),
        r && n.add(r),
    ...
    ot.prototype.destroy = function() {
        ...
        s.flush(!0, t).destroy(),
        N(i, n.itemVisibleClass),
        N(i, n.itemHiddenClass),
        this._item = null,
    ...
    ,
    ot.prototype._startAnimation = function(t, i, e) {
        if (!this._isDestroyed) {
            var s, n = this._item, r = n.getGrid()._settings, o = t ? r.visibleStyles : r.hiddenStyles, h = parseInt(t ? r.showDuration : r.hideDuration) || 0, a = (t ? r.showEasing : r.hideEasing) || "ease", _ = i || h <= 0;
            if (o) {
                if (p.cancel(n._id + "visibility"),
                _)
                    return n._animateChild.isAnimating() ? n._animateChild.stop(o) : d(n._child, o),
                    void (e && e());
                p.add(n._id + "visibility", function() {
                    s = l(n._child, o)
                }, function() {
    ...
    ,
    ot.prototype._stopAnimation = function(t) {
        if (!this._isDestroyed) {
            var i = this._item;
            p.cancel(i._id),
    ...
    ,
    ot.prototype._finishShow = function() {
        this._isHidden || (this._isShowing = !1,
        this._queue.flush(!1, this._item))
    }
    ;
    var ht = {};
    ot.prototype._finishHide = function() {
        if (this._isHidden) {
            var t = this._item;
            this._isHiding = !1,
            ht.transform = k(0, 0),
    ...
    function ct(t, i, e) {
        ...
        i.style.top = "0",
        i.style[h] = k(0, 0),
        this._animate = new f(this,i),
        this._animateChild = new f(this,this._child),
        this._visibility = new ot(this),
        this._layout = new it(this),
        this._migrate = new st(this),
        this._release = new rt(this),
        this._drag = s.dragEnabled ? new U(this) : null,
    ...
    ct.prototype.getGrid = function() {
        return e[this._gridId]
    }
    ,
    ct.prototype.getElement = function() {
    ...
    ,
    ct.prototype.isShowing = function() {
        return !(!this._visibility || !this._visibility._isShowing)
    }
    ,
    ct.prototype.isHiding = function() {
        return !(!this._visibility || !this._visibility._isHiding)
    }
    ,
    ct.prototype.isPositioning = function() {
    ...
    ,
    ct.prototype.isReleasing = function() {
        return !(!this._release || !this._release._isActive)
    }
    ,
    ct.prototype.isDestroyed = function() {
        return this._isDestroyed
    }
    ,
    ct.prototype._refreshDimensions = function() {
        if (!this._isDestroyed && !this._visibility._isHidden) {
            var t = this._element
              , i = t.getBoundingClientRect();
            this._width = i.width,
            this._height = i.height,
            this._marginLeft = Math.max(0, I(t, "margin-left")),
            this._marginRight = Math.max(0, I(t, "margin-right")),
            this._marginTop = Math.max(0, I(t, "margin-top")),
            this._marginBottom = Math.max(0, I(t, "margin-bottom"))
        }
    }
    ,
    ct.prototype._refreshSortData = function() {
        if (!this._isDestroyed) {
    ...
    ,
    ct.prototype._destroy = function(t) {
        if (!this._isDestroyed) {
            var i = this._element
              , e = this.getGrid()
              , s = e._settings
    ...
    ,
    pt.prototype.getLayout = function(t, i, e, s) {
        var n, r = this._layout, o = !(!s || !s.fillGaps), h = !(!s || !s.horizontal), a = !(!s || !s.alignRight), _ = !(!s || !s.alignBottom), l = !(!s || !s.rounding);
        if (r.slots.length = r.slotSizes.length = 0,
        r.width = h ? 0 : l ? Math.round(i) : i,
        r.height = h ? l ? Math.round(e) : e : 0,
        r.setWidth = h,
        r.setHeight = !h,
        !t.length)
            return r;
        for (n = 0; n < t.length; n++)
            this._addSlot(t[n], h, o, l);
        if (a)
            for (n = 0; n < r.slots.length; n += 2)
                r.slots[n] = r.width - (r.slots[n] + r.slotSizes[n]);
        if (_)
            for (n = 1; n < r.slots.length; n += 2)
                r.slots[n] = r.height - (r.slots[n] + r.slotSizes[n]);
    ...
    ,
    pt.prototype._addSlot = (at = {},
    function(t, i, e, s) {
        var n, r, o, h, a, _, l = this._layout, d = this._freeSlots, f = this._newSlots;
        for (f.length = 0,
        at.left = null,
        at.top = null,
        at.width = t._width + t._marginLeft + t._marginRight,
        at.height = t._height + t._marginTop + t._marginBottom,
        s && (at.width = Math.round(at.width),
        at.height = Math.round(at.height)),
        a = 0; a < d.length; a++)
            if ((r = d[a]) && (n = this._getRect(r),
            at.width <= n.width + .001 && at.height <= n.height + .001)) {
                at.left = n.left,
                at.top = n.top;
                break
            }
        for (null === at.left && (at.left = i ? l.width : 0,
        at.top = i ? 0 : l.height,
        e || (h = !0)),
        !i && at.top + at.height > l.height && (at.left > 0 && f.push(this._addRect(0, l.height, at.left, 1 / 0)),
        at.left + at.width < l.width && f.push(this._addRect(at.left + at.width, l.height, l.width - at.left - at.width, 1 / 0)),
        l.height = at.top + at.height),
        i && at.left + at.width > l.width && (at.top > 0 && f.push(this._addRect(l.width, 0, 1 / 0, at.top)),
        at.top + at.height < l.height && f.push(this._addRect(l.width, at.top + at.height, 1 / 0, l.height - at.top - at.height)),
        l.width = at.left + at.width),
        a = e ? 0 : h ? d.length : a; a < d.length; a++)
            if (r = d[a])
                for (n = this._getRect(r),
                o = this._splitRect(n, at),
                _ = 0; _ < o.length; _++)
                    r = o[_],
                    (n = this._getRect(r)).width > .49 && n.height > .49 && (!i && n.top < l.height || i && n.left < l.width) && f.push(r);
        f.length && this._purgeRects(f).sort(i ? this._sortRectsLeftTop : this._sortRectsTopLeft),
        i ? l.width = Math.max(l.width, at.left + at.width) : l.height = Math.max(l.height, at.top + at.height),
        l.slots.push(at.left, at.top),
        l.slotSizes.push(at.width, at.height),
        this._freeSlots = f,
        this._newSlots = d
    }
    ),
    pt.prototype._addRect = function(t, i, e, s) {
        var n = ++this._rectId
          , r = this._rectStore;
        return r[n] = t || 0,
        r[++this._rectId] = i || 0,
    ...
    ,
    pt.prototype._getRect = function(t, i) {
    ...
    ,
    pt.prototype._splitRect = (_t = [],
    function(t, i) {
        return _t.length = 0,
        this._doRectsOverlap(t, i) ? (t.left < i.left && _t.push(this._addRect(t.left, t.top, i.left - t.left, t.height)),
        t.left + t.width > i.left + i.width && _t.push(this._addRect(i.left + i.width, t.top, t.left + t.width - (i.left + i.width), t.height)),
        t.top < i.top && _t.push(this._addRect(t.left, t.top, t.width, i.top - t.top)),
        t.top + t.height > i.top + i.height && _t.push(this._addRect(t.left, i.top + i.height, t.width, t.top + t.height - (i.top + i.height))),
        _t) : (_t.push(this._addRect(t.left, t.top, t.width, t.height)),
        _t)
    }
    ),
    pt.prototype._doRectsOverlap = function(t, i) {
        return !(t.left + t.width <= i.left || i.left + i.width <= t.left || t.top + t.height <= i.top || i.top + i.height <= t.top)
    }
    ,
    pt.prototype._isRectWithinRect = function(t, i) {
        return t.left >= i.left && t.top >= i.top && t.left + t.width <= i.left + i.width && t.top + t.height <= i.top + i.height
    }
    ,
    pt.prototype._purgeRects = (lt = {},
    dt = {},
    function(t) {
        for (var i, e = t.length; e--; )
            if (i = t.length,
            t[e])
                for (this._getRect(t[e], lt); i--; )
                    if (t[i] && e !== i && this._isRectWithinRect(lt, this._getRect(t[i], dt))) {
                        t[e] = 0;
                        break
                    }
        return t
    ...
    pt.prototype._sortRectsTopLeft = function() {
        var t = {}
          , i = {};
        return function(e, s) {
    ...
    pt.prototype._sortRectsLeftTop = function() {
        var t = {}
          , i = {};
        return function(e, s) {
            return this._getRect(e, t),
    ...
    function vt(t) {
        return yt(t) ? Array.prototype.slice.call(t) : Array.prototype.concat(t)
    }
    var wt = new pt
      , Dt = function() {};
    function bt(t, i) {
        ...
        "function" != typeof (s = this._settings = function(t, i) {
            ...
            e
        }(bt.defaultOptions, i)).dragSort && (s.dragSort = !!s.dragSort),
        this._id = ut(),
        e[this._id] = h,
        this._isDestroyed = !1,
        this._layout = {
        ...
        this._emitter = new n,
        v(t, s.containerClass),
        this._items = [],
        "string" == typeof (r = s.items) ? vt(t.children).forEach(function(t) {
            ("*" === r || y(t, r)) && h._items.push(new ct(h,t))
        }) : (Array.isArray(r) || yt(r)) && (this._items = vt(r).map(function(t) {
            return new ct(h,t)
        })),
        "number" != typeof (o = s.layoutOnResize) && (o = !0 === o ? 0 : -1),
        o >= 0 && window.addEventListener("resize", h._resizeHandler = C(function() {
    ...
    function St(t, i) {
        ...
        for (n = 0; n < o; n++)
            e = B(i[s = r[n]]),
            B(t[s]) && e ? t[s] = St(St({}, t[s]), i[s]) : e ? t[s] = St({}, i[s]) : Array.isArray(i[s]) ? t[s] = i[s].slice(0) : t[s] = i[s];
        return t
    }
    return bt.Item = ct,
    bt.ItemLayout = it,
    bt.ItemVisibility = ot,
    bt.ItemRelease = rt,
    bt.ItemMigrate = st,
    bt.ItemAnimate = f,
    bt.ItemDrag = U,
    ...
    bt.prototype.on = function(t, i) {
        return this._emitter.on(t, i),
        this
    }
    ,
    bt.prototype.once = function(t, i) {
        return this._emitter.once(t, i),
        this
    }
    ,
    bt.prototype.off = function(t, i) {
        return this._emitter.off(t, i),
        this
    }
    ,
    bt.prototype.getElement = function() {
        return this._element
    }
    ,
    bt.prototype.getItems = function(t) {
    ...
    ,
    bt.prototype.refreshItems = function(t) {
        if (this._isDestroyed)
            return this;
    ...
    ,
    bt.prototype.refreshSortData = function(t) {
        if (this._isDestroyed)
            return this;
        var i, e = this.getItems(t);
        for (i = 0; i < e.length; i++)
    ...
    ,
    bt.prototype.synchronize = function() {
        if (this._isDestroyed)
            return this;
    ...
    ,
    bt.prototype.layout = function(t, i) {
        if (this._isDestroyed)
            return this;
    ...
    ,
    bt.prototype.show = function(t, i) {
        return this._isDestroyed ? this : (this._setItemsVisibility(t, !0, i),
        this)
    }
    ,
    bt.prototype.hide = function(t, i) {
        return this._isDestroyed ? this : (this._setItemsVisibility(t, !1, i),
        this)
    }
    ,
    bt.prototype.filter = function(t, i) {
        if (this._isDestroyed || !this._items.length)
            return this;
        var e, s, n = [], r = [], o = "string" == typeof t, h = "function" == typeof t, a = i || 0, _ = !0 === a.instant, l = a.layout ? a.layout : void 0 === a.layout, d = "function" == typeof a.onFinish ? a.onFinish : null, f = -1, u = Dt;
        if (d && (u = function() {
        ...
        h || o)
            for (s = 0; s < this._items.length; s++)
                e = this._items[s],
                (h ? t(e) : y(e._element, t)) ? n.push(e) : r.push(e);
    ...
    bt.prototype.move = function(t, i, e) {
        if (this._isDestroyed || this._items.length < 2)
            return this;
    ...
    ,
    bt.prototype.send = function(t, i, e, s) {
    ...
    bt.prototype.destroy = function(t) {
        ...
        i = 0; i < n.length; i++)
            n[i]._destroy(t);
        return N(s, this._settings.containerClass),
        s.style.height = "",
        s.style.width = "",
        this._emit("destroy"),
    ...
    ,
    bt.prototype._getItem = function(t) {
        if (this._isDestroyed || !t && 0 !== t)
            return null;
        if ("number" == typeof t)
    ...
    ,
    bt.prototype._updateLayout = function() {
        var t, i = this._layout, e = this._settings.layout;
        for (++i.id,
        i.items.length = 0,
        t = 0; t < this._items.length; t++)
            this._items[t]._isActive && i.items.push(this._items[t]);
        this._refreshDimensions();
        var s = this._width - this._borderLeft - this._borderRight
          , n = this._height - this._borderTop - this._borderBottom
          , r = "function" == typeof e ? e(i.items.slice(0), s, n) : wt.getLayout(i.items, s, n, e);
        return i.slots = r.slots.slice(0),
        i.setWidth = Boolean(r.setWidth),
        i.setHeight = Boolean(r.setHeight),
        i.width = r.width,
        i.height = r.height,
        i
    }
    ,
    bt.prototype._emit = function() {
        this._isDestroyed || this._emitter.emit.apply(this._emitter, arguments)
    }
    ,
    bt.prototype._hasListeners = function(t) {
        var i = this._emitter._events[t];
        return !(!i || !i.length)
    }
    ,
    bt.prototype._updateBoundingRect = function() {
    ...
    ,
    bt.prototype._updateBorders = function(t, i, e, s) {
        var n = this._element;
        t && (this._borderLeft = I(n, "border-left-width")),
        i && (this._borderRight = I(n, "border-right-width")),
        e && (this._borderTop = I(n, "border-top-width")),
        s && (this._borderBottom = I(n, "border-bottom-width"))
    }
    ,
    bt.prototype._refreshDimensions = function() {
        this._updateBoundingRect(),
        this._updateBorders(1, 1, 1, 1)
    }
    ,
    bt.prototype._setItemsVisibility = function(t, i, e) {

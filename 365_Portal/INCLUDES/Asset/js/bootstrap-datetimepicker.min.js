!function (a) {
    ...
    var c = function (c, d) {
        var e, f, g, h, i, j, k, l = {}, m = !0, n = !1, o = !1, p = 0, q = [{
            ...
            var b = a("<thead>").append(a("<tr>").append(a("<th>").addClass("prev").attr("data-action", "previous").append(a("<i>").addClass(d.icons.previous))).append(a("<th>").addClass("picker-switch").attr("data-action", "pickerSwitch").attr("colspan", d.calendarWeeks ? "6" : "5")).append(a("<th>").addClass("next").attr("data-action", "next").append(a("<i>").addClass(d.icons.next))))
            ...
            return z("h") && (b.append(a("<td>").append(a("<a>").attr({
            ...
            }).addClass("btn").attr("data-action", "incrementHours").append(a("<i>").addClass(d.icons.up)))),
                ...
                }).addClass("btn").attr("data-action", "decrementHours").append(a("<i>").addClass(d.icons.down))))),
                z("m") && (z("h") && (b.append(a("<td>").addClass("separator")),
                    ...
                    }).addClass("btn").attr("data-action", "incrementMinutes").append(a("<i>").addClass(d.icons.up)))),
                    ...
                    }).addClass("btn").attr("data-action", "decrementMinutes").append(a("<i>").addClass(d.icons.down))))),
                z("s") && (z("m") && (b.append(a("<td>").addClass("separator")),
                    c.append(a("<td>").addClass("separator").html(":")),
                    e.append(a("<td>").addClass("separator"))),
                    b.append(a("<td>").append(a("<a>").attr({
                        href: "#",
                    ...
                    }).addClass("btn").attr("data-action", "incrementSeconds").append(a("<i>").addClass(d.icons.up)))),
                    ...
                    }).addClass("btn").attr("data-action", "decrementSeconds").append(a("<i>").addClass(d.icons.down))))),
            ...
            if ("auto" === g && (g = f.top + 1.5 * o.height() >= a(window).height() + a(window).scrollTop() && o.height() + c.outerHeight() < f.top ? "top" : "bottom"),
                ...
                "static" === b.css("position") && (b = b.parents().filter(function () {
            ...
            for (b.eq(0).find("span").attr("title", d.tooltips.prevDecade),
                ...
                h += '<span data-action="selectYear" class="year' + (c.isSame(e, "y") && !m ? " active" : "") + (R(c, "y") ? "" : " disabled") + '">' + c.year() + "</span>",
                    c.add(1, "y");
            a.find("td").html(h)
        }, V = function () {
            ...
            for (g.eq(0).find("span").attr("title", d.tooltips.prevCentury),
            ...
            if (B()) {
                for (i.eq(0).find("span").attr("title", d.tooltips.prevMonth),
            ...
            for (f.hour() > 11 && !h && c.hour(12); c.isSame(f, "d") && (h || f.hour() < 12 && c.hour() < 12 || f.hour() > 11);)
                c.hour() % 4 === 0 && (e = a("<tr>"),
                    d.push(e)),
                    e.append('<td data-action="selectHour" class="hour' + (R(c, "h") ? "" : " disabled") + '">' + c.format(h ? "HH" : "hh") + "</td>"),
                    c.add(1, "h");
            b.empty().append(d)
        }, Y = function () {
            for (var b = o.find(".timepicker-minutes table"), c = f.clone().startOf("h"), e = [], g = a("<tr>"), h = 1 === d.stepping ? 5 : d.stepping; f.isSame(c, "h");)
                c.minute() % (4 * h) === 0 && (g = a("<tr>"),
                    e.push(g)),
                    g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>"),
                    c.add(h, "m");
            b.empty().append(e)
        }, Z = function () {
            for (var b = o.find(".timepicker-seconds table"), c = f.clone().startOf("m"), d = [], e = a("<tr>"); f.isSame(c, "m");)
                c.second() % 20 === 0 && (e = a("<tr>"),
                    d.push(e)),
                    e.append('<td data-action="selectSecond" class="second' + (R(c, "s") ? "" : " disabled") + '">' + c.format("ss") + "</td>"),
                    c.add(5, "s");
            b.empty().append(d)
        }, $ = function () {
            ...
            selectMonth: function (b) {
                ...
                f.month(c),
                    k === p ? (aa(e.clone().year(f.year()).month(f.month())),
                        d.inline || ba()) : (L(-1),
                            W()),
                    K("M")
            },
            ...
            togglePicker: function (b) {
                ...
                if (g && g.length) {
                    if (c = g.data("collapse"),
                        c && c.transitioning)
                        return;
                    g.collapse ? (g.collapse("hide"),
                        h.collapse("show")) : (g.removeClass("in"),
                            h.addClass("in")),
                        e.is("i") ? e.toggleClass(d.icons.time + " " + d.icons.date) : e.find("i").toggleClass(d.icons.time + " " + d.icons.date)
                }
            },
            showPicker: function () {
        ...
        if (l.destroy = function () {
            ...
            l.daysOfWeekDisabled = function (a) {
                ...
                if (d.daysOfWeekDisabled = a.reduce(function (a, b) {
                    return b = parseInt(b, 10),
                        b > 6 || b < 0 || isNaN(b) ? a : (a.indexOf(b) === -1 && a.push(b),
                            a)
                }, []).sort(),
            ...
            l.defaultDate = function (a) {
                ...
                return d.defaultDate = b,
                    (d.defaultDate && d.inline || "" === g.val().trim()) && aa(d.defaultDate),
                    l
            }
            ,
            l.locale = function (a) {
            ...
            l.keyBinds = function (a) {
                return 0 === arguments.length ? d.keyBinds : (d.keyBinds = a,
                    l)
            }
            ,
